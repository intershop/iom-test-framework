                ...
                implements com.intershop.oms.test.servicehandler.orderservice.OMSOrderServiceHandler
{
    ...
    private static final Logger log = LoggerFactory.getLogger(OMSOrderServiceHandlerV2.class);

    public OMSOrderServiceHandlerV2(OMSDbHandler dbHandler, ServiceConfiguration serviceConfig)
    {
    ...
    {
        log.info("Create order called in service handler version 2.0 ---- doing nothing, anymore!");
        return orderData;
    }
